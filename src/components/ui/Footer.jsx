          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                ...
                <li><a href="#try-on" className="text-gray-300 hover:text-[#d4af37] transition-colors duration-300 text-base font-light" style={{ fontFamily: "'Inter', sans-serif", fontWeight: '300' }}>Virtual Try-On</a></li>
