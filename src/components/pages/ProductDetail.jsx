        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className={`space-y-8 transform transition-all duration-1000 delay-400 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-12 opacity-0'}`}>
            ...
            <div className="space-y-4">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>
                {product.name}
              </h1>
            ...
            <div className="space-y-6">
              {/* Color Selection */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Color: {selectedColor}
                </h3>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                <button
                  className="flex-1 bg-[#d4af37] hover:bg-[#d4af37]/90 text-black py-4 px-6 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-gray-200">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600" style={{ fontFamily: "'Playfair Display', serif" }}>Free Shipping</p>
              </div>
              <div className="text-center">
                <Shield className="w-8 h-8 text-[#d4af37] mx-auto mb-2" />
                <p className="text-sm text-gray-600" style={{ fontFamily: "'Playfair Display', serif" }}>2 Year Warranty</p>
              </div>
              <div className="text-center">
                <RotateCcw className="w-8 h-8 text-[#d4af37] mx-auto mb-2" />
                <p className="text-sm text-gray-600" style={{ fontFamily: "'Playfair Display', serif" }}>Easy Returns</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {product.features.map((feature, index) => (
                      <div key={index} className="flex items-center gap-3">
                        ...
                        <span className="text-gray-700" style={{ fontFamily: "'Playfair Display', serif" }}>{feature}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    {Object.entries(product.specifications).map(([key, value]) => (
                      <div key={key} className="flex justify-between py-2 border-b border-gray-200">
                        <span className="font-medium text-gray-700 capitalize" style={{ fontFamily: "'Playfair Display', serif" }}>
              ...
              {activeTab === 'reviews' && (
                <div className="space-y-6">
                  ...
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p style={{ fontFamily: "'Playfair Display', serif" }}>Reviews feature coming soon</p>
                  </div>
                </div>
              )}
            </div>
